...
CREATE TABLE Skills (SkillID Int NOT NULL, CONSTRAINT PK_SkillIDSkills PRIMARY KEY (SkillID), Rate Int NOT NULL, SkillCode varchar(3) NOT NULL, FringeBenefits Int NOT NULL);
