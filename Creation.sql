...
CREATE TABLE Project (ProjectID Int NOT NULL, CONSTRAINT PK_ProjectIDProject PRIMARY KEY (ProjectID), ProjectNumber varchar(40) NOT NULL, OrganizationID Int NOT NULL, LocationID Int NOT NULL, EstimatedCost Int NOT NULL, didWin varchar(1) NOT NULL, Details varchar(40) NOT NULL);
