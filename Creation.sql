...
CREATE TABLE Person (PersonID Int NOT NULL, CONSTRAINT PK_PersonIDPerson PRIMARY KEY (PersonID), LastName Varchar(40) NOT NULL, FirstName Varchar(40) NOT NULL, Email Varchar(40) NOT NULL, StreetAddress Varchar(40) NOT NULL, City Varchar(40) NOT NULL, State Varchar(40) NOT NULL, ZIP Varchar(40) NOT NULL, Type varchar(10) NOT NULL);
