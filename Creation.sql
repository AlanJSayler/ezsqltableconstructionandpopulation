...
CREATE TABLE Demographic (Demographic Int NOT NULL, CONSTRAINT PK_DemographicDemographic PRIMARY KEY (Demographic), Description varchar(40) NOT NULL);
CREATE TABLE Employee (PersonID Int NOT NULL, CONSTRAINT PK_PersonIDEmployee PRIMARY KEY (PersonID), DateHired Date NOT NULL, Demographic Int NOT NULL, Gender varchar(1) NOT NULL, IsUnionMember varchar(1) NOT NULL, EmployeeNumber varchar(40) NOT NULL, MaritalStatus varchar(1) NOT NULL);
...
CREATE TABLE Location (LocationID Int NOT NULL, CONSTRAINT PK_LocationIDLocation PRIMARY KEY (LocationID), StreetAddress Varchar(40) NOT NULL, City Varchar(40) NOT NULL, State Varchar(40) NOT NULL, ZIP Varchar(40) NOT NULL, SiteVisited Varchar(1) NOT NULL, LocationDescription Varchar(300) NOT NULL, VisitationNotes Varchar(40) NOT NULL);
...
CREATE TABLE Person (PersonID Int NOT NULL, CONSTRAINT PK_PersonIDPerson PRIMARY KEY (PersonID), LastName Varchar(40) NOT NULL, FirstName Varchar(40) NOT NULL, Email Varchar(40) NOT NULL, StreetAddress Varchar(40) NOT NULL, City Varchar(40) NOT NULL, State Varchar(40) NOT NULL, ZIP Varchar(40) NOT NULL, Type varchar(10) NOT NULL, MiddleInitial varchar(1) NOT NULL, Phone varchar(20) NOT NULL);
